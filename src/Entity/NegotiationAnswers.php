...
use App\Repository\NegotiationAnswersRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: NegotiationAnswersRepository::class)]
class NegotiationAnswers
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToOne(inversedBy: 'negotiationAnswers', cascade: ['persist', 'remove'])]
    private ?NegotiationQuestions $idquestion = null;
    ...
    public function getIdquestion(): ?NegotiationQuestions
    {
        return $this->idquestion;
    }

    public function setIdquestion(?NegotiationQuestions $idquestion): static
    {
